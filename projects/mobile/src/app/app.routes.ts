...
export const routes: Routes = [
  ...
  // --- Shell autenticado (listados / índices) ---
  {
    ...
    children: [
      ...
      {
        path: 'configuracion/musica/estilo',
        canActivate: [permisoGuard],
        data: { title: 'Mi estilo', permiso: 'MUSICA_CONFIGURAR' },
        loadComponent: () => import('./pages/configuracion/musica/musica-estilo.page').then((m) => m.MusicaEstiloPage),
      },
      {
        path: 'configuracion/musica/repertorio',
        canActivate: [permisoGuard],
        data: { title: 'Repertorio', permiso: 'MUSICA_CONFIGURAR' },
        loadComponent: () => import('./pages/configuracion/musica/musica-repertorio.page').then((m) => m.MusicaRepertorioPage),
      },
      {
        path: 'configuracion/musica/estilos',
        canActivate: [permisoGuard],
