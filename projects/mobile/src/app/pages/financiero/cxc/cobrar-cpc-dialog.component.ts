...
/**
 * Cobrar una cuota de Cuenta por Cobrar hacia la Caja Mayor (efectivo). El
 * cobro a cuenta bancaria queda en el escritorio. Requiere CPC_COBRAR.
 * Devuelve `true` si se cobró.
 */
@Component({
  ...
  template: `
    ...
    <mat-dialog-content>
      ...
      <form [formGroup]="form" class="col">
        ...
        <p class="efectivo">Se cobra en <strong>{{ efectivoLabel }}</strong> hacia la caja mayor.</p>
