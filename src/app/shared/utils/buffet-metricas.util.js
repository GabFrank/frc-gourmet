...
exports.resumirMetricasBuffet = void 0;
function resumirMetricasBuffet(items, kgProducidos) {
    const lista = items || [];
    ...
    return {
        ...
        pesoMedioGramosPorVenta: cantidadVentas > 0 ? Math.round(pesoNetoGramos / cantidadVentas) : 0,
...
exports.resumirMetricasBuffet = resumirMetricasBuffet;
//# sourceMappingURL=buffet-metricas.util.js.map