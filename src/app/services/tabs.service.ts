...
export class TabsService {
   ...
   * Add a new tab
   */
  addTab(title: string, componentType: Type<any>, data?: any, id?: string, closable: boolean = true): number {
   ...
   */
  openTab(title: string, componentType: Type<any>, data: any = {}, id?: string, closable: boolean = true): number {
   ...
   */
  openTabWithData(title: string, componentType: Type<any>, data: any = {}, id?: string, closable: boolean = true): number {
    const tabId = id || uuidv4();
