...
export const MENU_TREE: MenuNode[] = [
  ...
  // ═══════════════════════════ FACTURACIÓN ═══════════════════════════
  {
    ...
    children: [
      ...
      { id: 'facturacion-config', label: 'Configuración', icon: 'settings', esConfig: true,
