  ...
  // ═══════════════════════════ FINANCIERO ═══════════════════════════
  {
    ...
    children: [
        ...
        action: { component: ListCajasComponent, title: 'Cajas', tabId: 'cajas-tab', data: NAV } },
      {
        ...
        children: [
          { id: 'cajas-mayor', label: 'Cajas Mayor', icon: 'account_balance', permiso: 'CAJA_MAYOR_OPERAR',
          ...
          { id: 'cuentas-por-pagar', label: 'Cuentas por Pagar', icon: 'request_quote', permiso: 'COMPRAS_GESTIONAR',
      ...
      },
      {
        ...
        children: [
          ...
          { id: 'gasto-categorias', label: 'Categorías de Gasto', icon: 'category', permiso: 'CAJA_MAYOR_OPERAR', esConfig: true,
          ...
          { id: 'entrada-varia-categorias', label: 'Categorías de Entradas Varias', icon: 'category', permiso: 'CAJA_MAYOR_OPERAR', esConfig: true,
          ...
          { id: 'operacion-financiera-categorias', label: 'Categorías de Op. Financieras', icon: 'category', permiso: 'CAJA_MAYOR_OPERAR', esConfig: true,
