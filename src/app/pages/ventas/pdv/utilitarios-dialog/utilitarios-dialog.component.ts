  ...
  opciones: UtilitarioOption[] = [
    {
      ...
      icono: 'output',
      color: '#e65100',
      // El retiro queda FLOTANTE (no toca Caja Mayor hasta que alguien con
      // CAJA_MAYOR_OPERAR lo ingrese). El cajero puede crearlo con PDV_RETIRO;
      // el gerente/admin lo ve vía CAJA_MAYOR_OPERAR.
      permisoAny: ['PDV_RETIRO', 'CAJA_MAYOR_OPERAR'],
    },
    {
      key: 'GASTOS',
      titulo: 'Gastos',
