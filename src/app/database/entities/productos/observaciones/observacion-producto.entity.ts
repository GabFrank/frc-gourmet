...
import { GrupoObservacion } from './grupo-observacion.entity';
...
export class ObservacionProducto extends BaseModel {
  ...
  @Column({ name: 'grupo_observacion_id' })
  grupoObservacionId!: number;
  
  @ManyToOne('GrupoObservacion', 'observacionesProductos', { onDelete: 'CASCADE' })
  @JoinColumn({ name: 'grupo_observacion_id' })
  grupoObservacion!: GrupoObservacion;
