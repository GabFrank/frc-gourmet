...
| **Tests** | 🟩 e2e | `scripts/test-pedidos-online-e2e.ts` (`npm run test:pedidos-online`): 26 asserts del flujo real (menú, OTP, pedido pickup/delivery, bandeja admin) contra SQLite+Fastify. 26/26 ✅. |
