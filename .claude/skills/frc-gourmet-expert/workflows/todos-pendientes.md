...
> 📌 **El orden de ataque está en [`## Plan de implementación priorizado (P0→P5)`](#plan-de-implementación-priorizado-p0p5) al final.** Esta sección de arriba es el catálogo detallado.

## Recientemente completado

- [x] **Imagen en Presentación + Sabor** (auditado 2026-06-08) — `app-file-upload` implementado en `producto-presentaciones-precios` y `sabor-dialog`. (Estaba listado como pendiente: era drift.)
