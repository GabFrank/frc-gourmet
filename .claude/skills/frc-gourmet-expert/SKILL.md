...
- **Primer release stable publicado: `v1.1.0` (2026-05-15)** — antes solo hubo alphas de develop. La consolidación develop→master fue PR #23. Inmediatamente salió `v1.1.1` con fix de `pg` que faltaba en el bundle (ver [conventions/pitfalls-typeorm-electron.md](conventions/pitfalls-typeorm-electron.md)).
